...
- Opened: [#178733](https://github.com/pytorch/pytorch/issues/178733) torch.any and torch.all with CPU input and CUDA out tensor r (@DeLightor)
...
### atom
- Opened: [#445](https://github.com/ROCm/ATOM/pull/445) [WIP] load quark gpt oss (@haoyangli0109)
...
- [#178733](https://github.com/pytorch/pytorch/issues/178733) torch.any and torch.all with CPU input and CUDA out tensor r (@DeLightor)
