...
- Opened: [#178770](https://github.com/pytorch/pytorch/issues/178770) [MPS] `nn.BatchNorm2d` tensors are not broadcast compatible (@hvaara)
...
- Opened: [#178769](https://github.com/pytorch/pytorch/issues/178769) [CPU] Cholesky decomposition broken for N>64 (@Isalia20)
...
- Opened: [#178745](https://github.com/pytorch/pytorch/issues/178745) DISABLED test_dtensor_basic_compile (__main__.TestDTensorCom (@guangyey)
- Opened: [#178748](https://github.com/pytorch/pytorch/issues/178748) DISABLED test_benchmark_harness_no_pickle_for_opaque_inputs  (@guangyey)
...
- Opened: [#38555](https://github.com/vllm-project/vllm/pull/38555) [ROCm] Skip encoder cache profiling on consumer RDNA GPUs (@dondetir)
...
- Opened: [#450](https://github.com/ROCm/ATOM/pull/450) CI: add /mnt/dcgpuval/models fallback for model cache path (@gyohuangxin)
...
- [#178770](https://github.com/pytorch/pytorch/issues/178770) [MPS] `nn.BatchNorm2d` tensors are not broadcast compatible (@hvaara)
...
- [#178769](https://github.com/pytorch/pytorch/issues/178769) [CPU] Cholesky decomposition broken for N>64 (@Isalia20)
