...
- Opened: [#189932](https://github.com/llvm/llvm-project/pull/189932) [AMDGPU] Allow merging unordered and monotonic atomic loads  (@harrisonGPU)
- Opened: [#190095](https://github.com/llvm/llvm-project/pull/190095) [AMDGPU] Add DummySchedWrite to avoid multiple issue cycles (@jrbyrnes)
...
- Opened: [#190036](https://github.com/llvm/llvm-project/pull/190036) [AMDGPU] True16 support for bf16 clamp pattern on gfx1250 (@rampitec)
- Opened: [#190009](https://github.com/llvm/llvm-project/pull/190009) Amdgpu simplify demanded bits for readfirstlane. (@lakreite)
- Opened: [#190020](https://github.com/llvm/llvm-project/pull/190020) [AMDGPU] Add AMDGPU support for llvm-objcopy (@david-salinas)
- Opened: [#190012](https://github.com/llvm/llvm-project/pull/190012) [AMDGPU][NFC] Update gating target feature for SWMMAC instru (@chinmaydd)
- Opened: [#189981](https://github.com/llvm/llvm-project/pull/189981) [AMDGPU] Mark ASYNCMARK as meta instruction to fix hazard cy (@adeshcom14)
- Opened: [#189339](https://github.com/llvm/llvm-project/pull/189339) [AMDGPU][MLIR][NFC] moved enc computation to a dedicated met (@ravil-mobile)
...
- Merged: [#179084](https://github.com/llvm/llvm-project/pull/179084) [CIR][AMDGPU] Lower Language specific address spaces and imp (@RiverDave)
- Merged: [#187735](https://github.com/llvm/llvm-project/pull/187735) [AMDGPU] Define new targets gfx1171 and gfx1172 (@mbrkusanin)
- Merged: [#183297](https://github.com/llvm/llvm-project/pull/183297) [AMDGPU] Fix crash with dead frame indices in debug values (@skatrak)
- Merged: [#176304](https://github.com/llvm/llvm-project/pull/176304) [AMDGPU] Disable generic DAG combines at -O0 to preserve deb (@dfukalov)
