...
- Opened: [#176140](https://github.com/pytorch/pytorch/pull/176140) [distributed][CI] share PGs to shorten distributed CI time (@weifengpy)
- Opened: [#175839](https://github.com/pytorch/pytorch/pull/175839) [inductor] Make addcmul/addcdiv decomp skip unconditional an (@mlazos)
...
- Opened: [#176132](https://github.com/pytorch/pytorch/pull/176132) Align input types of lambda function in logical reduce kerne (@anatoliylitv)
- Opened: [#175658](https://github.com/pytorch/pytorch/pull/175658) Factor out CPU _scaled_mm methods (@slayton58)
- Opened: [#176013](https://github.com/pytorch/pytorch/pull/176013) Add CUDA header inclusion in CUDASymmetricMemoryTypes.hpp (@alexdremov)
...
### jax
- Opened: [#35496](https://github.com/jax-ml/jax/pull/35496) [ROCm] Use prebuilt wheels for rocm plugin deps (@alekstheod)
...
- Opened: [#35731](https://github.com/vllm-project/vllm/pull/35731) AITER MLA backend: Fix CPU sync in _build_decode (@pschlan-amd)
...
- Opened: [#35722](https://github.com/vllm-project/vllm/pull/35722) Hanlin12 hip online tuning (@hanlin12-AMD)
...
- Opened: [#35720](https://github.com/vllm-project/vllm/pull/35720) [Bugfix] fix kv cache fp8 crash on sm<89 (@fo40225)
...
- Opened: [#35699](https://github.com/vllm-project/vllm/pull/35699) [CLOSED]Support multimodal speculative decoding in non-paral (@EanWang211123)
...
- Opened: [#35173](https://github.com/vllm-project/vllm/pull/35173) [Kernel] Immediately execute argument assertions in wvSplitK (@wjabbour)
...
- Merged: [#35042](https://github.com/vllm-project/vllm/pull/35042) [Platform] Add current_platform.num_compute_units interface (@jikunshang)
...
- Merged: [#35043](https://github.com/vllm-project/vllm/pull/35043) [ROCm][CI] Fix spec decode profile assertion and logprob tes (@AndreasKaratzas)
...
- Merged: [#19162](https://github.com/sgl-project/sglang/pull/19162) [ROCm] Use unreg path for custom all-reduce during CUDA grap (@zyzshishui)
...
- Opened: [#38507](https://github.com/openxla/xla/pull/38507) [ROCM] Fixed triton_support_test on rocm. (@zoranjovanovic-ns)
...
- Opened: [#38259](https://github.com/openxla/xla/pull/38259) PR #37074: [ROCm] Reenable miopen autotune when xla_gpu_auto (@copybara-service[bot])
...
- Opened: [#38224](https://github.com/openxla/xla/pull/38224) [ROCm] Use VLOG(1) for tracer teardown logs (@AratiGanesh)
- Opened: [#38400](https://github.com/openxla/xla/pull/38400) [ROCm] Refactor cub_sort_kernel_rocm.cu.cc (@mfrancepillois)
- Opened: [#38269](https://github.com/openxla/xla/pull/38269) [ROCm] Add RCCL FP8 support (@mfrancepillois)
- Opened: [#38364](https://github.com/openxla/xla/pull/38364) PR #38360: [ROCm] Fix triton integration failures (@copybara-service[bot])
- Opened: [#38333](https://github.com/openxla/xla/pull/38333) dev scaled dot for rocm (@ScXfjiang)
- Opened: [#38258](https://github.com/openxla/xla/pull/38258) [ROCm] Add hipBLASLt GEMM TF32 support (@Eetusjo)
- Opened: [#38159](https://github.com/openxla/xla/pull/38159) Remove CUDA/ROCM Platform dependencies in `xla_compile` bina (@copybara-service[bot])
- Opened: [#38219](https://github.com/openxla/xla/pull/38219) PR #38169: [ROCm] Make rocm rbe pool configurable (@copybara-service[bot])
- Opened: [#38208](https://github.com/openxla/xla/pull/38208) PR #38156: [ROCm] fix se_gpu_pjrt_client_test target (@copybara-service[bot])
...
- Merged: [#4627](https://github.com/ROCm/AMDMIGraphX/pull/4627) rocMLIR Weekly Sync 2026-02-22 (@github-actions[bot])
...
### pytorch
- [#176152](https://github.com/pytorch/pytorch/issues/176152) DISABLED test_adam_ema_update_scalar_precision_beta2_0_1 (__ (@guangyey)
...
- [#175831](https://github.com/pytorch/pytorch/issues/175831) Numerical discrepancy in nn.Linear between eager and compile (@zifan6699)
- [#175830](https://github.com/pytorch/pytorch/issues/175830) Numerical discrepancy in nn.LSTM between eager and compile m (@zifan6699)
- [#176147](https://github.com/pytorch/pytorch/issues/176147) DISABLED test_fake_device_property_normalization_propagate_r (@etaf)
- [#176146](https://github.com/pytorch/pytorch/issues/176146) DISABLED test_flex_attention_with_dynamic_max_autotune_cuda  (@pytorch-bot[bot])
- [#176145](https://github.com/pytorch/pytorch/issues/176145) DISABLED test_deleted_mempool_not_used_on_oom (__main__.Test (@pytorch-bot[bot])
- [#176144](https://github.com/pytorch/pytorch/issues/176144) DISABLED test_graph_partition_user_defined_triton_kernel_reu (@pytorch-bot[bot])
- [#176143](https://github.com/pytorch/pytorch/issues/176143) DISABLED test_graph_partition_user_defined_triton_kernel_reu (@pytorch-bot[bot])
- [#176142](https://github.com/pytorch/pytorch/issues/176142) DISABLED test_clear_saved_tensors_on_access_double_access_er (@pytorch-bot[bot])
- [#176111](https://github.com/pytorch/pytorch/issues/176111) DISABLED test_replicate_wrong_device_id_type (__main__.Repli (@pytorch-bot[bot])
- [#176115](https://github.com/pytorch/pytorch/issues/176115) DISABLED test_template_epilogue_fusion_occupancy_ratio_test_ (@pytorch-bot[bot])
- [#176116](https://github.com/pytorch/pytorch/issues/176116) DISABLED test_template_epilogue_fusion_static_analysis_test_ (@pytorch-bot[bot])
- [#176114](https://github.com/pytorch/pytorch/issues/176114) DISABLED test_template_epilogue_fusion_dominating_epilogue_t (@pytorch-bot[bot])
- [#176113](https://github.com/pytorch/pytorch/issues/176113) DISABLED test_template_epilogue_fusion_dominating_epilogue_t (@pytorch-bot[bot])
- [#176110](https://github.com/pytorch/pytorch/issues/176110) DISABLED test_comprehensive_linalg_svd_cuda_float32 (__main_ (@pytorch-bot[bot])
...
- [#35725](https://github.com/vllm-project/vllm/issues/35725) [Bug]: .venv/lib/python3.10/site-packages/flashinfer/data/in (@ymshuang)
...
- [#35713](https://github.com/vllm-project/vllm/issues/35713) [Feature] [ROCm]: Enable AITER `fused_allreduce_rmsnorm_quan (@tjtanaa)
- [#35712](https://github.com/vllm-project/vllm/issues/35712) [Feature] [ROCm]: Enable AITER `fused_allreduce_rmsnorm` (@tjtanaa)
...
- [#35705](https://github.com/vllm-project/vllm/issues/35705) [Bug]: streaming mode+finish_reason length, delta content no (@ajiang17)
...
- [#35641](https://github.com/vllm-project/vllm/issues/35641) [Bug]: ROCm MI355X Kimi K2.5 AITER TP8 MLA kernel Error (num (@functionstackx)
- [#35504](https://github.com/vllm-project/vllm/issues/35504) [Bug]: qwen3-coder-next inference randomly hangs, accuracy d (@vitush93)
- [#35624](https://github.com/vllm-project/vllm/issues/35624) [Bug]: Qwen3-Omni Model Fails when try to l (@Blaze-DSP)
- [#35644](https://github.com/vllm-project/vllm/issues/35644) [Feature]: AMD MXFP4 MiniMax M2.5 Checkpoint (@functionstackx)
- [#35642](https://github.com/vllm-project/vllm/issues/35642) [Bug]: HIP build in Docker: offload-arch stderr contaminates (@npathak13)
