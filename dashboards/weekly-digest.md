...
### llvm
- Opened: [#189191](https://github.com/llvm/llvm-project/pull/189191) AMDGPU: Add range attribute to mbcnt intrinsic callsites (@arsenm)
...
- Merged: [#187840](https://github.com/llvm/llvm-project/pull/187840) [AMDGPU][GlobalISel] Add RegBankLegalize rules for amdgcn_pe (@gandhi56)
...
- Merged: [#37778](https://github.com/vllm-project/vllm/pull/37778) [ROCm][CI] Added missing resampy dependency for MM audio tes (@AndreasKaratzas)
- Merged: [#37780](https://github.com/vllm-project/vllm/pull/37780) [ROCm][CI] Make some duplicated tests optional so that they  (@AndreasKaratzas)
...
### sglang
- Opened: [#21628](https://github.com/sgl-project/sglang/pull/21628) [AMD] Add TurboQuant KV cache compression (--kv-cache-dtype  (@JohnQinAMD)
