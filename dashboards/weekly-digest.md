...
### aiter
- Opened: [#2474](https://github.com/ROCm/aiter/pull/2474) CI: DO NOT MERGE - test pip editable install path (@gyohuangxin)
- Opened: [#2473](https://github.com/ROCm/aiter/pull/2473) CI: Install setuptools_scm and vcs_versioning before aiter s (@gyohuangxin)
